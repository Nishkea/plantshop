...
export default function Header({link, cart}) {
   return (
      <>
         <header className='w-full bg-slate-100 border-b px-2 md:px-0'>
            <div className='container mx-auto py-5 flex justify-between items-center'>
               <h1 className="text-3xl font-bold flex items-center">🌱 Seedling <span className='text-sm ml-2 font-medium text-black/50'>| voor alle voorbeeld planten</span></h1>
